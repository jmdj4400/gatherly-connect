...
const translations: Record<Language, Record<string, string>> = {
  da: {
    ...
    'landing.features.title': 'Bygget til dem der møder op alene',
    'landing.why.title': 'Hvorfor Gatherly?',
  ...
  en: {
    ...
    'landing.features.title': 'Built for those who show up alone',
    'landing.why.title': 'Why Gatherly?',
